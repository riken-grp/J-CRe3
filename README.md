...
[[Paper (en)]](https://aclanthology.org/2024.lrec-main.829/)
...
- `agreement/`: Textual annotation files and raw annotation files collected to measure the inter-annotator
  agreement. The files in this directory are in the same format as the `textual_annotations` and `raw_annotations`
  directories.
